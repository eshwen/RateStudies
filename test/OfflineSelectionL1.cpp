...
int main(int argc, char** argv){
  ...
  if(atoi(argv[7])==1) VBFHHbbTauTauSignal= true;
  ...
  if(VBFHHbbTauTauSignal)    LLRdir = "/data_CMS/cms/amendola/LLRHTauTauNtuples/HiggsTauTauOutput_VBFHHTo2B2Tau_CV_1_C2V_1_C3_1/";
  ...
  TString fileList;
  if (VBFHHbbTauTauSignal) fileList = "../fileLists/SignalMC/VBFHHTo2B2Tau_CV_1_C2V_1_C3_1.txt";
  ...
  if(VBFHHbbTauTauSignal) fOut= LLRdir+(Form("VBFHHbbTauTauSignal_VBFseed_DiTauPtseed_%.0lf_%.0lf_%.0lf.root",VBF_OnlineETleadjetcut,VBF_OnlineETsubjetcut,VBF_OnlineMjjcut));
  ...
  TH1D* Mjj_VBF_pass = new TH1D ("Mjj_VBF_pass", "", 32, 400, 2000);
  TH1D* Mjj_VBF = new TH1D ("Mjj_VBF", "",32, 400, 2000);
  TH1D* Mjj_VBFMatched_pass = new TH1D ("Mjj_VBFMatched_pass", "", 32, 400, 2000);
  TH1D* Mjj_VBF_tot = new TH1D ("Mjj_VBF_tot", "",32, 400, 2000);
  TH1D* Mjj_ditau = new TH1D ("Mjj_DiTau", "",32, 400, 2000);
  TH1D* Mjj_ditau_VBF = new TH1D ("Mjj_DiTau_VBF", "",32, 400, 2000);
  TH1D* Mjj_ditau_noVBF = new TH1D ("Mjj_DiTau_noVBF", "",32, 400, 2000);
  TH1D* Mjj_noditau_VBF = new TH1D ("Mjj_noDiTau_VBF", "",32, 400, 2000);
  TH1D* Mjj_noditau_VBFbySeed = new TH1D ("Mjj_noDiTau_NewbySeed", "",32, 400, 2000);
  TH1D* Mjj_noditau_VBFbySel = new TH1D ("Mjj_noDiTau_NewbySel", "",32, 400, 2000);
  TH1D* Mjj_noditau_VBFbyBoth = new TH1D ("Mjj_noDiTau_NewbyBoth", "",32, 400, 2000);
  TH1D* Mjj_noditau_VBFsel = new TH1D ("Mjj_noDiTau_VBFsel", "",32, 400, 2000);
  TH1D* Mjj_or = new TH1D ("Mjj_or", "",32,400, 2000);
  TH1D* Mjj_and = new TH1D ("Mjj_and", "",32,400, 2000);
  ...
  if(VBFHHbbTauTauSignal)fPlotsDiTauPt = TFile::Open(Form("%sVBFHHbbTauTauSignal_DiTauPtseed_%.0lf_%.0lf.root", LLRdir.Data(),Boost_OnlinePTtaucut,Boost_OnlinePTpaircut),"recreate");  
  ...
  TChain *tInput = new TChain ("HTauTauTree/HTauTauTree");
 ...
 bool L1_DoubleJet_X_Y_MjYjY_Z = false;
  ...
  for (long int iEv = 0; true ; iEv++){
	...
	if(tlv_tau.Pt()>pt_tau_cut && fabs(tlv_tau.Eta())<2.1 && ((tauID->at(i)>>5)&1) && ((tauID->at(i)>>7)&1) && ((tauID->at(i)>>5)&11)){
	  ...
	  if (MatchingTau)     OffTau.push_back(tlv_tau);
      }
    }
    }
	...
	double jetEta  = stage2_jetEta->at(iL1);
