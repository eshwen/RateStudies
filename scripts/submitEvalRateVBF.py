...
parser.add_argument('--lmin', dest='lmin', type=int, help='minimum lumisection', default=-999)
parser.add_argument('--lmax', dest='lmax', type=int, help='maximum lumisection', default=-999)
...
for listname in inputlists:
    ...
    command = command + ' ' + outFolder + ' ' + outDir+'/'+listFileName  + ' ' + str(args.pu) + ' ' + str(args.trID) + ' ' +str(args.emu) + ' '+ str(args.run) + ' '+ str(args.fill) +' '+  str(args.m)+' '+  str(args.lmin)+' '+  str(args.lmax)
